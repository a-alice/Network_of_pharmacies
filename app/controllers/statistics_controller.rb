class StatisticsController < ApplicationController
  ...
  def create
    respond_to do |format|
      if @statistic.save
        format.html { redirect_to @statistic, notice: t('helpers.success-crt') }
  ...
  def update
    respond_to do |format|
      if @statistic.update(statistic_params)
        format.html { redirect_to @statistic, notice: t('helpers.success-upd') }
  ...
  private
    ...
    def statistic_params
      params.require(:statistic).permit(:number, :quantity)
    end
end
