class PharmaciesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pharmacy.save
        format.html { redirect_to @pharmacy, notice: t('helpers.success-crt') }
  ...
  def update
    respond_to do |format|
      if @pharmacy.update(pharmacy_params)
        format.html { redirect_to @pharmacy, notice: t('helpers.success-upd') }
  ...
  private
    ...
    def pharmacy_params
      params.require(:pharmacy).permit(:address, :number, :subway)
    end
end
